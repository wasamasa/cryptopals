...
# decryption to validate them, and spat out an error if they were of
# the wrong parity.
#
...
# - If you double a ciphertext (multiply it by (2**e)%n), the
#   resulting plaintext will (obviously) be either even or odd.
...
#
# You can repeatedly apply this heuristic, once per bit of the
# message, checking your oracle function each time.
#
